#!/bin/bash
# TradePlusCoin Masternode Setup Script V1 for Ubuntu 16.04 LTS
#
...
wget https://github.com/tdpsdevextreme/TradePlusCoin/releases/download/v1.0/TradePlus-1.0-daemon-ubuntu_16.04.tar.gz
tar -xzvf TradePlus-1.0-daemon-ubuntu_16.04.tar.gz
