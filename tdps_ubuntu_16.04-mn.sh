#!/bin/bash
# TradePlusCoin Masternode Setup Script V2 for Ubuntu 16.04 LTS
#
...
wget https://github.com/tdpsdevextreme/TradePlusCoin/releases/download/v2.0/TradePlus-2.0-daemon-ubuntu_16.04.tar.gz
tar -xzvf TradePlus-2.0-daemon-ubuntu_16.04.tar.gz
